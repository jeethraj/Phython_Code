...
##st.sidebar.image('Tecnotree.png', use_column_width=True)
##st.sidebar.title('Tecnotree Report')
...
tabs = st.tabs(["HOME", "OVER ALL CUSTOMER", "MIGRATED CUSTOMER","PAYAS YOU GO"])
#tabs = st.sidepa(["HOME", "OVER ALL CUSTOMER", "MIGRATED CUSTOMER","PAYAS YOU GO"])
